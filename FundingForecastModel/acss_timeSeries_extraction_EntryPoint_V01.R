...
if(onlyACSS){
  ...
  gc();
  print("Loading Used Functions");
  source('C:/Users/sbewaji/Documents/Development Workspaces/R-Workspace/FundingForecastModel/acss_timeSeries_extraction_V01.R', encoding = 'UTF-8', echo=TRUE);
  gc();
  ...
  gc();
  print("Loading Used Functions");
  source('C:/Users/sbewaji/Documents/Development Workspaces/R-Workspace/FundingForecastModel/acssusbe_timeSeries_extraction_V02.R', encoding = 'UTF-8', echo=TRUE);
  gc();
