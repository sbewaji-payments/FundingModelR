...
measurementUnitType <- "Value"; #possible entries are "Volume", "Value"
if(measurementUnitType == "Volume"){
  measurementUnit <- 1000000; #possible values 1000000000, 1000000, 1000, or 1
  }else{
  measurementUnit <- 1000000000; #possible values 1,000,000,000, 1000000, 1000, or 1
}
...
arimaDrift <- TRUE;
arimaConstant <- TRUE;##SARIMA Modle additional parameters
...
modelSelection <- "ARIMA";##select with forecast model to use can take the form SARIMA, ARIMA, etc
...
if(dataFrequency == "monthly"){
  ...
  if(measurementUnitType == "Volume"){
    ...
    forecastsSavePathMainDir <- 
      c(paste("C:/Users/sbewaji/Documents/Development Workspaces/R-Workspace/FundingForecastModel/MonthlyForecasts/FI_Level/LVTS/Volume/",
              forecastDate,sep = ""));
    ...
    forecastsSavePathMainDir <- 
      c(paste("C:/Users/sbewaji/Documents/Development Workspaces/R-Workspace/FundingForecastModel/MonthlyForecasts/FI_Level/LVTS/Value/",
              forecastDate,sep = ""));
  ...
  if(measurementUnitType == "Volume"){
    ...
    forecastsSavePathMainDir <- 
      c(paste("C:/Users/sbewaji/Documents/Development Workspaces/R-Workspace/FundingForecastModel/DailyForecasts/FI_Level/LVTS/Volume/",
              forecastDate,sep = ""));
    # forecastsErrorsSavePath <- 
    #   c(paste0("C:/Users/sbewaji/Documents/ModelResults/FundingForecastModel/DailyForecasts/FI_Level/LVTS/",
    #           forecastDate, "/","BenchMarking","/", modelSelection,"ForecastErrorsACSSUSBE.RData", sep = ""));
    ##Save path must be broken up to allow R to create directories. It cannot create full directory paths of 
    ##main directory and sub directory in one command
    forecastsErrorsSavePathMainDir<- 
...
if(modelSelection=="ARIMA"){
  ...
  source('C:/Users/sbewaji/Documents/Development Workspaces/R-Workspace/FundingForecastModel/lvts_timeSeries_analysis_ARIMA_V02.R', encoding = 'UTF-8', echo=TRUE);
  gc();
}else if(modelSelection=="SARIMA"){
  print("LVTS SARIMA Timeseries Forecasts Generation");
  source('C:/Users/sbewaji/Documents/Development Workspaces/R-Workspace/FundingForecastModel/lvts_timeSeries_analysis_SARIMA_V02.R', encoding = 'UTF-8', echo=TRUE);
  gc();
}
