...
if(under50K){
  LVTSTXNsDataSeriesSentRecieved <- LVTSTXNsUpto50k;
  setnames(LVTSTXNsDataSeriesSentRecieved, "TotalVolumeReceivedUpto50k", "RecievedVolume")
  setnames(LVTSTXNsDataSeriesSentRecieved, "TotalValueReceivedUpto50k", "RecievedValue")
  setnames(LVTSTXNsDataSeriesSentRecieved, "TotalVolumeSentUpto50k", "SentVolume")
  setnames(LVTSTXNsDataSeriesSentRecieved, "TotalValueSentUpto50k", "SentValue")
} else{
  LVTSTXNsDataSeriesSentRecieved <- LVTSTXNsOver50k;
  setnames(LVTSTXNsDataSeriesSentRecieved, "TotalVolumeReceivedOver50k", "RecievedVolume")
  setnames(LVTSTXNsDataSeriesSentRecieved, "TotalValueReceivedOver50k", "RecievedValue")
  setnames(LVTSTXNsDataSeriesSentRecieved, "TotalVolumeSentOver50k", "SentVolume")
  setnames(LVTSTXNsDataSeriesSentRecieved, "TotalValueSentOver50k", "SentValue")
}
...
LVTSFIVolumeTimeSeriesDataTable <- 
...
LVTSFIValueTimeSeriesDataTable <- 
...
LVTSFIVolumeTimeSeriesDataTable <- list.names(LVTSFIVolumeTimeSeriesDataTable,"LVTSFITimeSeriesList");
LVTSFIValueTimeSeriesDataTable <- list.names(LVTSFIValueTimeSeriesDataTable,"LVTSFITimeSeriesList");
list.save(LVTSFIVolumeTimeSeriesDataTable, LVTSFIVolumeTimeSeriesDataTableSavePath);
list.save(LVTSFIValueTimeSeriesDataTable, LVTSFIValueTimeSeriesDataTableSavePath);
