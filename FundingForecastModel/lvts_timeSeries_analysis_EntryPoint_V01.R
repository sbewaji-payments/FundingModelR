...
source('C:/Users/sbewaji/Documents/Development Workspaces/R-Workspace/FundingForecastModel/lvts_timeSeries_analysis_functions_V01.R', encoding = 'UTF-8', echo=TRUE);
gc();
