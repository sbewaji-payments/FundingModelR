...
#                                                  by.y=c("receiver","Year"),all.x = TRUE, all.y = TRUE);
  ...
  if(byTranche & !byStream){
    ...
    by=c("sender","senderFullName","date","tranche", "settlementMechanism")];
    ...
    by=c("date","tranche", "settlementMechanism")];
    ...
    by=c("date","sender","senderID","senderFullName","receiver","receiverID","receiverFullName","tranche", "settlementMechanism")];
    ...
    by=c("sender","senderID","senderFullName","date","tranche", "settlementMechanism")];
    
    LVTSTXNsDataSeriesRecieved  <-  mergedLVTSTXNsYearsSpecYM[, list(RecievedVolume=sum(TotalVolume), RecievedValue=sum(TotalValue)
    ), 
    by=c("receiver","receiverID","receiverFullName","date","tranche", "settlementMechanism")];
...
#                                                  by.y=c("receiver","date","tranche"),all.x = TRUE, all.y = TRUE);
    ...
    LVTSTXNsDataSeriesSentRecieved_df  <-  merge(LVTSTXNsDataSeriesRecieved_df, LVTSTXNsDataSeriesSent_df, by.x=c("receiver","date", "tranche"),
                                                 by.y=c("sender","date", "tranche", "settlementMechanism"), all.x = TRUE, all.y = TRUE);
    ...
    setnames(LVTSTXNsDataSeriesSentRecieved, "receiver", "sender");
    LVTSTXNsDataSeriesSentRecieved<- LVTSTXNsDataSeriesSentRecieved[, c("TotalVolume") := sum(SentVolume, RecievedVolume), 
                                                                      with = FALSE, by=c("sender","date","tranche", "settlementMechanism")];
    LVTSTXNsDataSeriesSentRecieved<- LVTSTXNsDataSeriesSentRecieved[, c("TotalValue") := sum(SentValue, RecievedValue), 
                                                                      with = FALSE, by=c("sender","date","tranche", "settlementMechanism")];
    ...
    by=c("sender","senderFullName","date","tranche", "settlementMechanism", "stream")];
    ...
    by=c("date","tranche", "settlementMechanism", "stream")];
    LVTSTXNsDataSeriesByPeriod <-   LVTSTXNsDataSeriesByPeriod[order(date), ];
    ...
    by=c("date","sender","senderID","senderFullName","receiver","receiverID","receiverFullName","tranche", "settlementMechanism", "stream")];
    ...
    by=c("sender","senderID","senderFullName","date","tranche", "settlementMechanism", "stream")];
    
    LVTSTXNsDataSeriesRecieved  <-  mergedLVTSTXNsYearsSpecYM[, list(RecievedVolume=sum(TotalVolume), RecievedValue=sum(TotalValue)
    ), 
    by=c("receiver","receiverID","receiverFullName","date","tranche", "settlementMechanism", "stream")];
    ...
    LVTSTXNsDataSeriesSentRecieved_df  <-  merge(LVTSTXNsDataSeriesRecieved_df, LVTSTXNsDataSeriesSent_df, by.x=c("receiver","date", "tranche", "settlementMechanism", "stream"),
                                                 by.y=c("sender","date", "tranche", "settlementMechanism", "stream"), all.x = TRUE, all.y = TRUE);
    ...
    setnames(LVTSTXNsDataSeriesSentRecieved, "receiver", "sender");
    LVTSTXNsDataSeriesSentRecieved<- LVTSTXNsDataSeriesSentRecieved[, c("TotalVolume") := sum(SentVolume, RecievedVolume), 
                                                                    with = FALSE, by=c("sender","date","tranche", "settlementMechanism", "stream")];
    LVTSTXNsDataSeriesSentRecieved<- LVTSTXNsDataSeriesSentRecieved[, c("TotalValue") := sum(SentValue, RecievedValue), 
                                                                    with = FALSE, by=c("sender","date","tranche", "settlementMechanism", "stream")];
...
##New line to save by period data. Need to add to paths in Entry point script
write.csv(LVTSTXNsDataSeriesByPeriod, file=LVTSTXNsDataSeriesByPeriodXLSSavePath);
